...
namespace Wetzel
{
    ...
    public:
        ...
        /**
         * @brief Retorna o objeto da classe e TRAVA outros uso do ponteiro por meio de semaphoro binario
         * @note Implementação especial
         * @return Ponteiro da classe local_storage
         */
        static local_storage *GetObjs();

        /**
         * @brief Libera o ponteiro da classe que está consumindo e libera o semaphoro binario
         * @return SEMPRE RETORNA NULL
         */
        local_storage *GiveObjs();
    ...
    private:
        ...
        mes_type_t _mes_storage[12];
        uint8_t _buffer_storage;
        static local_storage *_ptr_local_storage;

        /* Semaphoro da classe */
        static SemaphoreHandle_t _ptr_local_storage_binary;
    };
} // namespace Wetzel
#endif