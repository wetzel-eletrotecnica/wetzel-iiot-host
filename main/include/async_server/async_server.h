...
namespace Wetzel
{
    ...
    public:
        ...
        /**
         * @brief Le a string recebida por UART e se for do tipo relatório adiciona na rede
    ...
    private:
        ...
        /**
         * @brief Retorna a string resposta do pedido feito pela UART
         * @note CALLBACK de uma requisição HTTP
         * @param response mensagem retorna pelo Device
         */
